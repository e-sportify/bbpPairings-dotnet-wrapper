...
public class Parser
{
    ...
    public class Player
    {
        ...
        public List<float> TieBreaks { get; set; } = new List<float>();
        public List<GameResult> Results { get; set; } = new List<GameResult>();
    }

    public class GameResult
    {
        public char Result { get; set; } // 'w', 'b', 'd', 'z', 'f', '+', 'h', '-'
        ...
        foreach (string line in lines)
        {
            ...
            switch (code)
            {
                ...
                case "132":
                    ...
                    break;
                case "001":
                    tournament.Players.Add(ParsePlayer(content, tournament.PlayedRounds));
                    break;
            }
        }
    ...
    private Player ParsePlayer(string playerData, int playedRounds)
    {
        Player player = new Player();

        // Tách dữ liệu theo khoảng trắng
        string[] parts = Regex.Split(playerData.Trim(), @"\s+");
        ...
        catch (Exception ex)
        {
            ...
            Console.WriteLine($"Dữ liệu: {playerData}");
        }
    ...
    public void WriteTrfFile(Tournament tournament, string filePath)
    {
        using (StreamWriter writer = new StreamWriter(filePath))
        {
            ...
            foreach (var player in tournament.Players)
            {
                ...
                writer.Write($"{player.Rating,4} {player.Federation,-3} {player.Id,-10} {player.Score,4:F1} ");
